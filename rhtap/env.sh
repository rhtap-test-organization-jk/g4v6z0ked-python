...
export IMAGE_URL=${IMAGE_URL-tssc-quay-quay-tssc-quay.apps.cluster-lsl2n.lsl2n.sandbox1297.opentlc.com/tssc/rhtap-qe-python:$CI_TYPE-$TAG}
...
export GITOPS_REPO_URL=https://github.com/rhtap-test-organization-jk/g4v6z0ked-python-gitops
